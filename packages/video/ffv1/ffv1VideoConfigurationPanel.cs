...
{
    public partial class ffv1VideoConfigurationPanel : UserControl
    {
        #region variables
        ...
        #region start / stop
        public ffv1VideoConfigurationPanel()
            : this(null, new VideoInfo())
        { }


        public ffv1VideoConfigurationPanel(MainForm mainForm, VideoInfo info)
        {
            loaded = false;
            InitializeComponent();
        }
